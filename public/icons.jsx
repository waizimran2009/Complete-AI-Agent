/* ───────────────────────────────────────────
   ...
   Stroke-based, 1.5px weight, 20px default
   (matches the lucide-react aesthetic used in
    QuantuMania's shadcn/ui setup)
   ─────────────────────────────────────────── */

function Icon({ children, size = 18, stroke = 1.6, style, ...rest }) {
  return (
    <svg
...
const IconVideo    = (p) => <Icon {...p}><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></Icon>;
...
const IconSparkles = (p) => <Icon {...p}><path d="M12 3v3M12 18v3M3 12h3M18 12h3M5.6 5.6l2.1 2.1M16.3 16.3l2.1 2.1M5.6 18.4l2.1-2.1M16.3 7.7l2.1-2.1"/><circle cx="12" cy="12" r="2"/></Icon>;
...
const IconPhoneOff = (p) => <Icon {...p}><path d="M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7 2 2 0 0 1 1.72 2v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.42 19.42 0 0 1-3.33-2.67m-2.67-3.34a19.79 19.79 0 0 1-3.07-8.63A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91"/><line x1="23" y1="1" x2="1" y2="23"/></Icon>;
...
const IconLogo     = (p) => <Icon {...p}><circle cx="12" cy="12" r="9"/><path d="M3 12c4-2 14-2 18 0M3 12c4 2 14 2 18 0"/><path d="M12 3c-2 4-2 14 0 18M12 3c2 4 2 14 0 18"/></Icon>;
...
Object.assign(window, {
  Icon, IconHome, IconPhone, IconMail, IconShare, IconVideo, IconUsers, IconBarChart, IconSettings,
  IconSearch, IconBell, IconPalette, IconPlus, IconSparkles, IconSend, IconMic, IconPhoneOff, IconClose,
  IconCheck, IconArrowUp, IconArrowDown, IconArrowRight, IconChevDown, IconClock, IconCalendar, IconLink,
  IconImage, IconPaperclip, IconStar, IconBriefcase, IconAlertTriangle, IconEye, IconEyeOff, IconCopy,
  IconFileText, IconLogo, IconPlay, IconPause, IconMenu, IconLinkedIn, IconTrending, IconZap, IconMonitor,
});
